...
CREATE TABLE IF NOT EXISTS materials (
  ...
  supervisor_status ENUM('em_revisao','nao_validado','validado_com_ajustes','valido') NULL DEFAULT NULL,
  coordinator_status ENUM('em_revisao','nao_validado','validado_com_ajustes','valido') NULL DEFAULT NULL,
